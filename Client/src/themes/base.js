...
const components = {
    MuiCssBaseline: {
        ...
        styleOverrides: (theme) => ({
            ...
            // Styling body
            body: Object.assign(Object.assign({}, (theme.palette.mode === "dark" ? darkScrollbar() : {})), { backgroundColor: theme.palette.background.default, margin: 0 }),
            // Height adjustment
            "html, body, #__next": {
                height: "100%",
            },
